      ...
      <nav>
        ...
        <div class="row" id="maindiv">
            <div class="col-auto">
                ...
                <button style="height:50px; width:200px;background-color:white;border-color:blue;color:white"type="button"><strong><a style="color:red" href="360.php">360</a></strong></button><br>
            </div>
            <div class="col-auto diet">
                <center><h2>360 Sugar Level Diet Plan</h2></center>
